  ...
  <template v-else>
    ...
    <main class="page-shell">
      ...
      <section v-if="activeSection === 'cases'" class="workspace cases-workspace">
        ...
        <div class="list-head case-list-head" style="grid-template-columns: .55fr 1.35fr 1.2fr 1.2fr 1.05fr 1.15fr 1fr .9fr 1fr;"><span>Автомобиль</span><span>Страховой случай</span><span>Страховая</span><span>Исполнитель</span><span>Запись</span><span>Детали</span><span>Статус</span><span>Дата создания</span></div>
