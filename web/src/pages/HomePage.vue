...
.case-parts-progress-cell { display: flex; align-items: center; gap: 9px; }.case-parts-progress-cell > div:last-child { display: grid; gap: 3px; }.case-parts-progress-cell strong { font-size: 12px; }.case-parts-progress-cell small { margin: 0; color: var(--muted); font-size: 10px; }.parts-progress-ring { width: 48px; height: 48px; display: grid; place-items: center; border-radius: 50%; background: conic-gradient(var(--green) var(--parts-progress), #dfe9e5 0); position: relative; font-size: 11px; font-weight: 850; }.parts-progress-ring::after { content: ''; position: absolute; inset: 6px; border-radius: 50%; background: white; }.parts-progress-ring span { position: relative; z-index: 1; }
...
.inline-appointment-date-input { width: 100%; min-height: 34px; padding: 0 7px; border: 1px solid var(--line); border-radius: 8px; color: var(--ink); background: var(--soft); font-size: 11px; }
