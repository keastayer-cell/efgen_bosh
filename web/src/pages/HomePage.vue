...
function startPlaceholderRepair() { repairMenuVisible.value = false; showToast('Раздел обычного ремонта пока готовится') }
function startInsuranceCaseFlow() {
  repairMenuVisible.value = false
...
function chooseRepairVehicle(car) {
