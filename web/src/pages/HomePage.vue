...
async function loadDirectories() {
  try {
    const [insurerItems, supplierItems, shiftItems] = await Promise.all([
        ...
        <div class="cars-list" aria-live="polite">
          ...
          <article v-for="car in visibleCars" :key="car.number" class="car-row" :class="`is-${car.status}`">
            <div class="car-summary">
              ...
              <div class="cell"><button class="link-button" @click="openStub('Документы')">Открыть папку</button></div>
