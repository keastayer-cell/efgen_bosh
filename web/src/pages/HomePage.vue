  ...
  <template v-else>
    ...
    <main class="page-shell">
      ...
      <section v-if="activeSection === 'cases'" class="workspace cases-workspace">
        ...
        <div class="list-head case-list-head"><span>Автомобиль</span><span>Страховой</span><span>Страховая компания</span><span>Исполнитель</span><span>Статус</span><span>Создан</span></div>
